...
import Overview from '@/app/[country]/dashboard/nutrition/Overview/page';
...
export default function NutritionDashboard() {
  ...
  if (loading) return <div className="text-[var(--olive-green)]">Loading Nutrition Dashboard...</div>;
    ...
    <div className="flex min-h-screen bg-[var(--white)] overflow-x-hidden">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-2xl font-bold text-[var(--dark-green)] mb-4">
          Nutrition Overview for {(country as string).charAt(0).toUpperCase() + (country as string).slice(1)}
        </h1>
        <Overview />
      </div>
    </div>
