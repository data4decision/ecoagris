...
const LivestockSidebar = ({ onCollapseChange }: LivestockSidebarProps) => {
  ...
  const nav = [
    { label: 'Overview', href: `/${country}/dashboard/livestock`, icon: FaChartBar },
    { label: 'Population', href: `/${country}/dashboard/livestock/population`, icon: FaLeaf },
    { label: 'Production', href: `/${country}/dashboard/livestock/production`, icon: FaIndustry },
