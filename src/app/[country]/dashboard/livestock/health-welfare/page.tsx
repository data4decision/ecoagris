...
export default function HealthStats() {
  ...
  const options = {
    ...
    scales: {
      ...
      y1: {
        title: { display: true, text: 'Vaccination Coverage (%)', color: 'var(--olive-green)' },
        position: 'left' as const,
        ticks: { color: 'var(--olive-green)' },
      },
      y2: {
        title: { display: true, text: 'FMD Incidents', color: 'var(--olive-green)' },
        position: 'right' as const,
        ticks: { color: 'var(--olive-green)' },
      },
      y3: {
        title: { display: true, text: 'Veterinary Facilities', color: 'var(--olive-green)' },
        position: 'right' as const,
        grid: { display: false },
        ticks: { color: 'var(--olive-green)' },
      },
